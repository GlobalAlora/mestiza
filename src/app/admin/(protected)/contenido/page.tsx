...
const SECTIONS: { title: string; description: string; fields: FieldDef[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        key: 'home.pilar1_stat',
        label: 'Pilar 1 — número/stat',
        type: 'input',
        placeholder: '2.000',
      },
      {
        key: 'home.pilar1_title',
        label: 'Pilar 1 — título',
        type: 'input',
        placeholder: 'metros sobre el mar',
      },
      {
        key: 'home.pilar1_body',
        label: 'Pilar 1 — descripción',
        type: 'textarea',
        rows: 2,
        placeholder: 'Viñedos en la Precordillera de Calingasta…',
      },
      { key: 'home.pilar2_stat', label: 'Pilar 2 — número/stat', type: 'input', placeholder: '4' },
      {
        key: 'home.pilar2_title',
        label: 'Pilar 2 — título',
        type: 'input',
        placeholder: 'raíces musicales',
      },
      {
        key: 'home.pilar2_body',
        label: 'Pilar 2 — descripción',
        type: 'textarea',
        rows: 2,
        placeholder: 'Flamenco, árabe, folclore y tango…',
      },
      { key: 'home.pilar3_stat', label: 'Pilar 3 — número/stat', type: 'input', placeholder: '1' },
      {
        key: 'home.pilar3_title',
        label: 'Pilar 3 — título',
        type: 'input',
        placeholder: 'región de autor',
      },
      {
        key: 'home.pilar3_body',
        label: 'Pilar 3 — descripción',
        type: 'textarea',
        rows: 2,
        placeholder: 'Calingasta es uno de los pocos valles de altura de Argentina…',
      },
      {
        key: 'home.prensa_label',
        label: 'Prensa — etiqueta sección',
        type: 'input',
        placeholder: 'Reconocimientos',
      },
      {
        key: 'home.quote1_text',
        label: 'Prensa — cita 1',
        type: 'textarea',
        rows: 2,
        placeholder: 'Una propuesta que une el arte y la tierra…',
      },
      {
        key: 'home.quote1_source',
        label: 'Prensa — fuente cita 1',
        type: 'input',
        placeholder: 'Revista de Vinos Argentina',
      },
      {
        key: 'home.award_badge',
        label: 'Prensa — texto del premio',
        type: 'input',
        placeholder: 'Carlos de Oro · Villa Carlos Paz',
      },
      {
        key: 'home.quote2_text',
        label: 'Prensa — cita 2 (opcional)',
        type: 'textarea',
        rows: 2,
        placeholder: 'Dejar vacío para ocultar',
      },
      {
        key: 'home.quote2_source',
        label: 'Prensa — fuente cita 2',
        type: 'input',
        placeholder: '',
      },
    ],
